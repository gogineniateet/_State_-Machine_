...
{
    public Idle(GameObject npc, NavMeshAgent agent, Animator animator, Transform playerPosition) : base(npc, agent, animator, playerPosition)
    {
...
{
    public Chase(GameObject npc, NavMeshAgent agent, Animator animator, Transform playerPosition) : base(npc, agent, animator, playerPosition)
    {
...
{
    public Death(GameObject npc, NavMeshAgent agent, Animator animator, Transform playerPosition) : base(npc, agent, animator, playerPosition)
    {
